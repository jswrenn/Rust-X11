...
pub static XCB_COPY_FROM_PARENT: u32 = 0;
...
pub static PTHREAD_CREATE_JOINABLE: ::libc::c_uint = 0;
pub static PTHREAD_CREATE_DETACHED: ::libc::c_uint = 1;
pub type Enum_Unnamed4 = ::libc::c_uint;
pub static PTHREAD_MUTEX_TIMED_NP: ::libc::c_uint = 0;
pub static PTHREAD_MUTEX_RECURSIVE_NP: ::libc::c_uint = 1;
pub static PTHREAD_MUTEX_ERRORCHECK_NP: ::libc::c_uint = 2;
pub static PTHREAD_MUTEX_ADAPTIVE_NP: ::libc::c_uint = 3;
pub static PTHREAD_MUTEX_NORMAL: ::libc::c_uint = 0;
pub static PTHREAD_MUTEX_RECURSIVE: ::libc::c_uint = 1;
pub static PTHREAD_MUTEX_ERRORCHECK: ::libc::c_uint = 2;
pub static PTHREAD_MUTEX_DEFAULT: ::libc::c_uint = 0;
pub type Enum_Unnamed5 = ::libc::c_uint;
pub static PTHREAD_MUTEX_STALLED: ::libc::c_uint = 0;
pub static PTHREAD_MUTEX_STALLED_NP: ::libc::c_uint = 0;
pub static PTHREAD_MUTEX_ROBUST: ::libc::c_uint = 1;
pub static PTHREAD_MUTEX_ROBUST_NP: ::libc::c_uint = 1;
pub type Enum_Unnamed6 = ::libc::c_uint;
pub static PTHREAD_PRIO_NONE: ::libc::c_uint = 0;
pub static PTHREAD_PRIO_INHERIT: ::libc::c_uint = 1;
pub static PTHREAD_PRIO_PROTECT: ::libc::c_uint = 2;
pub type Enum_Unnamed7 = ::libc::c_uint;
pub static PTHREAD_RWLOCK_PREFER_READER_NP: ::libc::c_uint = 0;
pub static PTHREAD_RWLOCK_PREFER_WRITER_NP: ::libc::c_uint = 1;
pub static PTHREAD_RWLOCK_PREFER_WRITER_NONRECURSIVE_NP: ::libc::c_uint = 2;
pub static PTHREAD_RWLOCK_DEFAULT_NP: ::libc::c_uint = 0;
pub type Enum_Unnamed8 = ::libc::c_uint;
pub static PTHREAD_INHERIT_SCHED: ::libc::c_uint = 0;
pub static PTHREAD_EXPLICIT_SCHED: ::libc::c_uint = 1;
pub type Enum_Unnamed9 = ::libc::c_uint;
pub static PTHREAD_SCOPE_SYSTEM: ::libc::c_uint = 0;
pub static PTHREAD_SCOPE_PROCESS: ::libc::c_uint = 1;
pub type Enum_Unnamed10 = ::libc::c_uint;
pub static PTHREAD_PROCESS_PRIVATE: ::libc::c_uint = 0;
pub static PTHREAD_PROCESS_SHARED: ::libc::c_uint = 1;
#[repr(C)]
...
pub static PTHREAD_CANCEL_ENABLE: ::libc::c_uint = 0;
pub static PTHREAD_CANCEL_DISABLE: ::libc::c_uint = 1;
pub type Enum_Unnamed12 = ::libc::c_uint;
pub static PTHREAD_CANCEL_DEFERRED: ::libc::c_uint = 0;
pub static PTHREAD_CANCEL_ASYNCHRONOUS: ::libc::c_uint = 1;
#[repr(C)]
...
pub struct __pthread_unwind_buf_t {
    pub __cancel_jmp_buf: [Struct_Unnamed13, ..1u],
...
pub static XCB_VISUAL_CLASS_STATIC_GRAY: ::libc::c_uint = 0;
pub static XCB_VISUAL_CLASS_GRAY_SCALE: ::libc::c_uint = 1;
pub static XCB_VISUAL_CLASS_STATIC_COLOR: ::libc::c_uint = 2;
pub static XCB_VISUAL_CLASS_PSEUDO_COLOR: ::libc::c_uint = 3;
pub static XCB_VISUAL_CLASS_TRUE_COLOR: ::libc::c_uint = 4;
pub static XCB_VISUAL_CLASS_DIRECT_COLOR: ::libc::c_uint = 5;
...
pub static XCB_EVENT_MASK_NO_EVENT: ::libc::c_uint = 0;
pub static XCB_EVENT_MASK_KEY_PRESS: ::libc::c_uint = 1;
pub static XCB_EVENT_MASK_KEY_RELEASE: ::libc::c_uint = 2;
pub static XCB_EVENT_MASK_BUTTON_PRESS: ::libc::c_uint = 4;
pub static XCB_EVENT_MASK_BUTTON_RELEASE: ::libc::c_uint = 8;
pub static XCB_EVENT_MASK_ENTER_WINDOW: ::libc::c_uint = 16;
pub static XCB_EVENT_MASK_LEAVE_WINDOW: ::libc::c_uint = 32;
pub static XCB_EVENT_MASK_POINTER_MOTION: ::libc::c_uint = 64;
pub static XCB_EVENT_MASK_POINTER_MOTION_HINT: ::libc::c_uint = 128;
pub static XCB_EVENT_MASK_BUTTON_1_MOTION: ::libc::c_uint = 256;
pub static XCB_EVENT_MASK_BUTTON_2_MOTION: ::libc::c_uint = 512;
pub static XCB_EVENT_MASK_BUTTON_3_MOTION: ::libc::c_uint = 1024;
pub static XCB_EVENT_MASK_BUTTON_4_MOTION: ::libc::c_uint = 2048;
pub static XCB_EVENT_MASK_BUTTON_5_MOTION: ::libc::c_uint = 4096;
pub static XCB_EVENT_MASK_BUTTON_MOTION: ::libc::c_uint = 8192;
pub static XCB_EVENT_MASK_KEYMAP_STATE: ::libc::c_uint = 16384;
pub static XCB_EVENT_MASK_EXPOSURE: ::libc::c_uint = 32768;
pub static XCB_EVENT_MASK_VISIBILITY_CHANGE: ::libc::c_uint = 65536;
pub static XCB_EVENT_MASK_STRUCTURE_NOTIFY: ::libc::c_uint = 131072;
pub static XCB_EVENT_MASK_RESIZE_REDIRECT: ::libc::c_uint = 262144;
pub static XCB_EVENT_MASK_SUBSTRUCTURE_NOTIFY: ::libc::c_uint = 524288;
pub static XCB_EVENT_MASK_SUBSTRUCTURE_REDIRECT: ::libc::c_uint = 1048576;
pub static XCB_EVENT_MASK_FOCUS_CHANGE: ::libc::c_uint = 2097152;
pub static XCB_EVENT_MASK_PROPERTY_CHANGE: ::libc::c_uint = 4194304;
pub static XCB_EVENT_MASK_COLOR_MAP_CHANGE: ::libc::c_uint = 8388608;
pub static XCB_EVENT_MASK_OWNER_GRAB_BUTTON: ::libc::c_uint = 16777216;
pub type xcb_event_mask_t = Enum_xcb_event_mask_t;
pub type Enum_xcb_backing_store_t = ::libc::c_uint;
pub static XCB_BACKING_STORE_NOT_USEFUL: ::libc::c_uint = 0;
pub static XCB_BACKING_STORE_WHEN_MAPPED: ::libc::c_uint = 1;
pub static XCB_BACKING_STORE_ALWAYS: ::libc::c_uint = 2;
...
pub static XCB_IMAGE_ORDER_LSB_FIRST: ::libc::c_uint = 0;
pub static XCB_IMAGE_ORDER_MSB_FIRST: ::libc::c_uint = 1;
...
pub static XCB_MOD_MASK_SHIFT: ::libc::c_uint = 1;
pub static XCB_MOD_MASK_LOCK: ::libc::c_uint = 2;
pub static XCB_MOD_MASK_CONTROL: ::libc::c_uint = 4;
pub static XCB_MOD_MASK_1: ::libc::c_uint = 8;
pub static XCB_MOD_MASK_2: ::libc::c_uint = 16;
pub static XCB_MOD_MASK_3: ::libc::c_uint = 32;
pub static XCB_MOD_MASK_4: ::libc::c_uint = 64;
pub static XCB_MOD_MASK_5: ::libc::c_uint = 128;
pub static XCB_MOD_MASK_ANY: ::libc::c_uint = 32768;
pub type xcb_mod_mask_t = Enum_xcb_mod_mask_t;
pub type Enum_xcb_key_but_mask_t = ::libc::c_uint;
pub static XCB_KEY_BUT_MASK_SHIFT: ::libc::c_uint = 1;
pub static XCB_KEY_BUT_MASK_LOCK: ::libc::c_uint = 2;
pub static XCB_KEY_BUT_MASK_CONTROL: ::libc::c_uint = 4;
pub static XCB_KEY_BUT_MASK_MOD_1: ::libc::c_uint = 8;
pub static XCB_KEY_BUT_MASK_MOD_2: ::libc::c_uint = 16;
pub static XCB_KEY_BUT_MASK_MOD_3: ::libc::c_uint = 32;
pub static XCB_KEY_BUT_MASK_MOD_4: ::libc::c_uint = 64;
pub static XCB_KEY_BUT_MASK_MOD_5: ::libc::c_uint = 128;
pub static XCB_KEY_BUT_MASK_BUTTON_1: ::libc::c_uint = 256;
pub static XCB_KEY_BUT_MASK_BUTTON_2: ::libc::c_uint = 512;
pub static XCB_KEY_BUT_MASK_BUTTON_3: ::libc::c_uint = 1024;
pub static XCB_KEY_BUT_MASK_BUTTON_4: ::libc::c_uint = 2048;
pub static XCB_KEY_BUT_MASK_BUTTON_5: ::libc::c_uint = 4096;
pub type xcb_key_but_mask_t = Enum_xcb_key_but_mask_t;
pub type Enum_xcb_window_enum_t = ::libc::c_uint;
pub static XCB_WINDOW_NONE: ::libc::c_uint = 0;
...
pub static XCB_BUTTON_MASK_1: ::libc::c_uint = 256;
pub static XCB_BUTTON_MASK_2: ::libc::c_uint = 512;
pub static XCB_BUTTON_MASK_3: ::libc::c_uint = 1024;
pub static XCB_BUTTON_MASK_4: ::libc::c_uint = 2048;
pub static XCB_BUTTON_MASK_5: ::libc::c_uint = 4096;
pub static XCB_BUTTON_MASK_ANY: ::libc::c_uint = 32768;
...
pub static XCB_MOTION_NORMAL: ::libc::c_uint = 0;
pub static XCB_MOTION_HINT: ::libc::c_uint = 1;
...
pub static XCB_NOTIFY_DETAIL_ANCESTOR: ::libc::c_uint = 0;
pub static XCB_NOTIFY_DETAIL_VIRTUAL: ::libc::c_uint = 1;
pub static XCB_NOTIFY_DETAIL_INFERIOR: ::libc::c_uint = 2;
pub static XCB_NOTIFY_DETAIL_NONLINEAR: ::libc::c_uint = 3;
pub static XCB_NOTIFY_DETAIL_NONLINEAR_VIRTUAL: ::libc::c_uint = 4;
pub static XCB_NOTIFY_DETAIL_POINTER: ::libc::c_uint = 5;
pub static XCB_NOTIFY_DETAIL_POINTER_ROOT: ::libc::c_uint = 6;
pub static XCB_NOTIFY_DETAIL_NONE: ::libc::c_uint = 7;
pub type xcb_notify_detail_t = Enum_xcb_notify_detail_t;
pub type Enum_xcb_notify_mode_t = ::libc::c_uint;
pub static XCB_NOTIFY_MODE_NORMAL: ::libc::c_uint = 0;
pub static XCB_NOTIFY_MODE_GRAB: ::libc::c_uint = 1;
pub static XCB_NOTIFY_MODE_UNGRAB: ::libc::c_uint = 2;
pub static XCB_NOTIFY_MODE_WHILE_GRABBED: ::libc::c_uint = 3;
...
pub static XCB_VISIBILITY_UNOBSCURED: ::libc::c_uint = 0;
pub static XCB_VISIBILITY_PARTIALLY_OBSCURED: ::libc::c_uint = 1;
pub static XCB_VISIBILITY_FULLY_OBSCURED: ::libc::c_uint = 2;
...
pub static XCB_PLACE_ON_TOP: ::libc::c_uint = 0;
pub static XCB_PLACE_ON_BOTTOM: ::libc::c_uint = 1;
...
pub static XCB_PROPERTY_NEW_VALUE: ::libc::c_uint = 0;
pub static XCB_PROPERTY_DELETE: ::libc::c_uint = 1;
...
pub static XCB_TIME_CURRENT_TIME: ::libc::c_uint = 0;
pub type xcb_time_t = Enum_xcb_time_t;
pub type Enum_xcb_atom_enum_t = ::libc::c_uint;
pub static XCB_ATOM_NONE: ::libc::c_uint = 0;
pub static XCB_ATOM_ANY: ::libc::c_uint = 0;
pub static XCB_ATOM_PRIMARY: ::libc::c_uint = 1;
pub static XCB_ATOM_SECONDARY: ::libc::c_uint = 2;
pub static XCB_ATOM_ARC: ::libc::c_uint = 3;
pub static XCB_ATOM_ATOM: ::libc::c_uint = 4;
pub static XCB_ATOM_BITMAP: ::libc::c_uint = 5;
pub static XCB_ATOM_CARDINAL: ::libc::c_uint = 6;
pub static XCB_ATOM_COLORMAP: ::libc::c_uint = 7;
pub static XCB_ATOM_CURSOR: ::libc::c_uint = 8;
pub static XCB_ATOM_CUT_BUFFER0: ::libc::c_uint = 9;
pub static XCB_ATOM_CUT_BUFFER1: ::libc::c_uint = 10;
pub static XCB_ATOM_CUT_BUFFER2: ::libc::c_uint = 11;
pub static XCB_ATOM_CUT_BUFFER3: ::libc::c_uint = 12;
pub static XCB_ATOM_CUT_BUFFER4: ::libc::c_uint = 13;
pub static XCB_ATOM_CUT_BUFFER5: ::libc::c_uint = 14;
pub static XCB_ATOM_CUT_BUFFER6: ::libc::c_uint = 15;
pub static XCB_ATOM_CUT_BUFFER7: ::libc::c_uint = 16;
pub static XCB_ATOM_DRAWABLE: ::libc::c_uint = 17;
pub static XCB_ATOM_FONT: ::libc::c_uint = 18;
pub static XCB_ATOM_INTEGER: ::libc::c_uint = 19;
pub static XCB_ATOM_PIXMAP: ::libc::c_uint = 20;
pub static XCB_ATOM_POINT: ::libc::c_uint = 21;
pub static XCB_ATOM_RECTANGLE: ::libc::c_uint = 22;
pub static XCB_ATOM_RESOURCE_MANAGER: ::libc::c_uint = 23;
pub static XCB_ATOM_RGB_COLOR_MAP: ::libc::c_uint = 24;
pub static XCB_ATOM_RGB_BEST_MAP: ::libc::c_uint = 25;
pub static XCB_ATOM_RGB_BLUE_MAP: ::libc::c_uint = 26;
pub static XCB_ATOM_RGB_DEFAULT_MAP: ::libc::c_uint = 27;
pub static XCB_ATOM_RGB_GRAY_MAP: ::libc::c_uint = 28;
pub static XCB_ATOM_RGB_GREEN_MAP: ::libc::c_uint = 29;
pub static XCB_ATOM_RGB_RED_MAP: ::libc::c_uint = 30;
pub static XCB_ATOM_STRING: ::libc::c_uint = 31;
pub static XCB_ATOM_VISUALID: ::libc::c_uint = 32;
pub static XCB_ATOM_WINDOW: ::libc::c_uint = 33;
pub static XCB_ATOM_WM_COMMAND: ::libc::c_uint = 34;
pub static XCB_ATOM_WM_HINTS: ::libc::c_uint = 35;
pub static XCB_ATOM_WM_CLIENT_MACHINE: ::libc::c_uint = 36;
pub static XCB_ATOM_WM_ICON_NAME: ::libc::c_uint = 37;
pub static XCB_ATOM_WM_ICON_SIZE: ::libc::c_uint = 38;
pub static XCB_ATOM_WM_NAME: ::libc::c_uint = 39;
pub static XCB_ATOM_WM_NORMAL_HINTS: ::libc::c_uint = 40;
pub static XCB_ATOM_WM_SIZE_HINTS: ::libc::c_uint = 41;
pub static XCB_ATOM_WM_ZOOM_HINTS: ::libc::c_uint = 42;
pub static XCB_ATOM_MIN_SPACE: ::libc::c_uint = 43;
pub static XCB_ATOM_NORM_SPACE: ::libc::c_uint = 44;
pub static XCB_ATOM_MAX_SPACE: ::libc::c_uint = 45;
pub static XCB_ATOM_END_SPACE: ::libc::c_uint = 46;
pub static XCB_ATOM_SUPERSCRIPT_X: ::libc::c_uint = 47;
pub static XCB_ATOM_SUPERSCRIPT_Y: ::libc::c_uint = 48;
pub static XCB_ATOM_SUBSCRIPT_X: ::libc::c_uint = 49;
pub static XCB_ATOM_SUBSCRIPT_Y: ::libc::c_uint = 50;
pub static XCB_ATOM_UNDERLINE_POSITION: ::libc::c_uint = 51;
pub static XCB_ATOM_UNDERLINE_THICKNESS: ::libc::c_uint = 52;
pub static XCB_ATOM_STRIKEOUT_ASCENT: ::libc::c_uint = 53;
pub static XCB_ATOM_STRIKEOUT_DESCENT: ::libc::c_uint = 54;
pub static XCB_ATOM_ITALIC_ANGLE: ::libc::c_uint = 55;
pub static XCB_ATOM_X_HEIGHT: ::libc::c_uint = 56;
pub static XCB_ATOM_QUAD_WIDTH: ::libc::c_uint = 57;
pub static XCB_ATOM_WEIGHT: ::libc::c_uint = 58;
pub static XCB_ATOM_POINT_SIZE: ::libc::c_uint = 59;
pub static XCB_ATOM_RESOLUTION: ::libc::c_uint = 60;
pub static XCB_ATOM_COPYRIGHT: ::libc::c_uint = 61;
pub static XCB_ATOM_NOTICE: ::libc::c_uint = 62;
pub static XCB_ATOM_FONT_NAME: ::libc::c_uint = 63;
pub static XCB_ATOM_FAMILY_NAME: ::libc::c_uint = 64;
pub static XCB_ATOM_FULL_NAME: ::libc::c_uint = 65;
pub static XCB_ATOM_CAP_HEIGHT: ::libc::c_uint = 66;
pub static XCB_ATOM_WM_CLASS: ::libc::c_uint = 67;
pub static XCB_ATOM_WM_TRANSIENT_FOR: ::libc::c_uint = 68;
...
pub static XCB_COLORMAP_STATE_UNINSTALLED: ::libc::c_uint = 0;
pub static XCB_COLORMAP_STATE_INSTALLED: ::libc::c_uint = 1;
pub type xcb_colormap_state_t = Enum_xcb_colormap_state_t;
pub type Enum_xcb_colormap_enum_t = ::libc::c_uint;
pub static XCB_COLORMAP_NONE: ::libc::c_uint = 0;
...
pub static XCB_MAPPING_MODIFIER: ::libc::c_uint = 0;
pub static XCB_MAPPING_KEYBOARD: ::libc::c_uint = 1;
pub static XCB_MAPPING_POINTER: ::libc::c_uint = 2;
...
pub static XCB_WINDOW_CLASS_COPY_FROM_PARENT: ::libc::c_uint = 0;
pub static XCB_WINDOW_CLASS_INPUT_OUTPUT: ::libc::c_uint = 1;
pub static XCB_WINDOW_CLASS_INPUT_ONLY: ::libc::c_uint = 2;
pub type xcb_window_class_t = Enum_xcb_window_class_t;
pub type Enum_xcb_cw_t = ::libc::c_uint;
pub static XCB_CW_BACK_PIXMAP: ::libc::c_uint = 1;
pub static XCB_CW_BACK_PIXEL: ::libc::c_uint = 2;
pub static XCB_CW_BORDER_PIXMAP: ::libc::c_uint = 4;
pub static XCB_CW_BORDER_PIXEL: ::libc::c_uint = 8;
pub static XCB_CW_BIT_GRAVITY: ::libc::c_uint = 16;
pub static XCB_CW_WIN_GRAVITY: ::libc::c_uint = 32;
pub static XCB_CW_BACKING_STORE: ::libc::c_uint = 64;
pub static XCB_CW_BACKING_PLANES: ::libc::c_uint = 128;
pub static XCB_CW_BACKING_PIXEL: ::libc::c_uint = 256;
pub static XCB_CW_OVERRIDE_REDIRECT: ::libc::c_uint = 512;
pub static XCB_CW_SAVE_UNDER: ::libc::c_uint = 1024;
pub static XCB_CW_EVENT_MASK: ::libc::c_uint = 2048;
pub static XCB_CW_DONT_PROPAGATE: ::libc::c_uint = 4096;
pub static XCB_CW_COLORMAP: ::libc::c_uint = 8192;
pub static XCB_CW_CURSOR: ::libc::c_uint = 16384;
pub type xcb_cw_t = Enum_xcb_cw_t;
pub type Enum_xcb_back_pixmap_t = ::libc::c_uint;
pub static XCB_BACK_PIXMAP_NONE: ::libc::c_uint = 0;
pub static XCB_BACK_PIXMAP_PARENT_RELATIVE: ::libc::c_uint = 1;
pub type xcb_back_pixmap_t = Enum_xcb_back_pixmap_t;
pub type Enum_xcb_gravity_t = ::libc::c_uint;
pub static XCB_GRAVITY_BIT_FORGET: ::libc::c_uint = 0;
pub static XCB_GRAVITY_WIN_UNMAP: ::libc::c_uint = 0;
pub static XCB_GRAVITY_NORTH_WEST: ::libc::c_uint = 1;
pub static XCB_GRAVITY_NORTH: ::libc::c_uint = 2;
pub static XCB_GRAVITY_NORTH_EAST: ::libc::c_uint = 3;
pub static XCB_GRAVITY_WEST: ::libc::c_uint = 4;
pub static XCB_GRAVITY_CENTER: ::libc::c_uint = 5;
pub static XCB_GRAVITY_EAST: ::libc::c_uint = 6;
pub static XCB_GRAVITY_SOUTH_WEST: ::libc::c_uint = 7;
pub static XCB_GRAVITY_SOUTH: ::libc::c_uint = 8;
pub static XCB_GRAVITY_SOUTH_EAST: ::libc::c_uint = 9;
pub static XCB_GRAVITY_STATIC: ::libc::c_uint = 10;
...
pub static XCB_MAP_STATE_UNMAPPED: ::libc::c_uint = 0;
pub static XCB_MAP_STATE_UNVIEWABLE: ::libc::c_uint = 1;
pub static XCB_MAP_STATE_VIEWABLE: ::libc::c_uint = 2;
...
pub static XCB_SET_MODE_INSERT: ::libc::c_uint = 0;
pub static XCB_SET_MODE_DELETE: ::libc::c_uint = 1;
...
pub static XCB_CONFIG_WINDOW_X: ::libc::c_uint = 1;
pub static XCB_CONFIG_WINDOW_Y: ::libc::c_uint = 2;
pub static XCB_CONFIG_WINDOW_WIDTH: ::libc::c_uint = 4;
pub static XCB_CONFIG_WINDOW_HEIGHT: ::libc::c_uint = 8;
pub static XCB_CONFIG_WINDOW_BORDER_WIDTH: ::libc::c_uint = 16;
pub static XCB_CONFIG_WINDOW_SIBLING: ::libc::c_uint = 32;
pub static XCB_CONFIG_WINDOW_STACK_MODE: ::libc::c_uint = 64;
pub type xcb_config_window_t = Enum_xcb_config_window_t;
pub type Enum_xcb_stack_mode_t = ::libc::c_uint;
pub static XCB_STACK_MODE_ABOVE: ::libc::c_uint = 0;
pub static XCB_STACK_MODE_BELOW: ::libc::c_uint = 1;
pub static XCB_STACK_MODE_TOP_IF: ::libc::c_uint = 2;
pub static XCB_STACK_MODE_BOTTOM_IF: ::libc::c_uint = 3;
pub static XCB_STACK_MODE_OPPOSITE: ::libc::c_uint = 4;
...
pub static XCB_CIRCULATE_RAISE_LOWEST: ::libc::c_uint = 0;
pub static XCB_CIRCULATE_LOWER_HIGHEST: ::libc::c_uint = 1;
...
pub static XCB_PROP_MODE_REPLACE: ::libc::c_uint = 0;
pub static XCB_PROP_MODE_PREPEND: ::libc::c_uint = 1;
pub static XCB_PROP_MODE_APPEND: ::libc::c_uint = 2;
...
pub static XCB_GET_PROPERTY_TYPE_ANY: ::libc::c_uint = 0;
...
pub static XCB_SEND_EVENT_DEST_POINTER_WINDOW: ::libc::c_uint = 0;
pub static XCB_SEND_EVENT_DEST_ITEM_FOCUS: ::libc::c_uint = 1;
...
pub static XCB_GRAB_MODE_SYNC: ::libc::c_uint = 0;
pub static XCB_GRAB_MODE_ASYNC: ::libc::c_uint = 1;
pub type xcb_grab_mode_t = Enum_xcb_grab_mode_t;
pub type Enum_xcb_grab_status_t = ::libc::c_uint;
pub static XCB_GRAB_STATUS_SUCCESS: ::libc::c_uint = 0;
pub static XCB_GRAB_STATUS_ALREADY_GRABBED: ::libc::c_uint = 1;
pub static XCB_GRAB_STATUS_INVALID_TIME: ::libc::c_uint = 2;
pub static XCB_GRAB_STATUS_NOT_VIEWABLE: ::libc::c_uint = 3;
pub static XCB_GRAB_STATUS_FROZEN: ::libc::c_uint = 4;
pub type xcb_grab_status_t = Enum_xcb_grab_status_t;
pub type Enum_xcb_cursor_enum_t = ::libc::c_uint;
pub static XCB_CURSOR_NONE: ::libc::c_uint = 0;
...
pub static XCB_BUTTON_INDEX_ANY: ::libc::c_uint = 0;
pub static XCB_BUTTON_INDEX_1: ::libc::c_uint = 1;
pub static XCB_BUTTON_INDEX_2: ::libc::c_uint = 2;
pub static XCB_BUTTON_INDEX_3: ::libc::c_uint = 3;
pub static XCB_BUTTON_INDEX_4: ::libc::c_uint = 4;
pub static XCB_BUTTON_INDEX_5: ::libc::c_uint = 5;
...
pub static XCB_GRAB_ANY: ::libc::c_uint = 0;
...
pub static XCB_ALLOW_ASYNC_POINTER: ::libc::c_uint = 0;
pub static XCB_ALLOW_SYNC_POINTER: ::libc::c_uint = 1;
pub static XCB_ALLOW_REPLAY_POINTER: ::libc::c_uint = 2;
pub static XCB_ALLOW_ASYNC_KEYBOARD: ::libc::c_uint = 3;
pub static XCB_ALLOW_SYNC_KEYBOARD: ::libc::c_uint = 4;
pub static XCB_ALLOW_REPLAY_KEYBOARD: ::libc::c_uint = 5;
pub static XCB_ALLOW_ASYNC_BOTH: ::libc::c_uint = 6;
pub static XCB_ALLOW_SYNC_BOTH: ::libc::c_uint = 7;
...
pub static XCB_INPUT_FOCUS_NONE: ::libc::c_uint = 0;
pub static XCB_INPUT_FOCUS_POINTER_ROOT: ::libc::c_uint = 1;
pub static XCB_INPUT_FOCUS_PARENT: ::libc::c_uint = 2;
pub static XCB_INPUT_FOCUS_FOLLOW_KEYBOARD: ::libc::c_uint = 3;
...
pub static XCB_FONT_DRAW_LEFT_TO_RIGHT: ::libc::c_uint = 0;
pub static XCB_FONT_DRAW_RIGHT_TO_LEFT: ::libc::c_uint = 1;
...
pub static XCB_GC_FUNCTION: ::libc::c_uint = 1;
pub static XCB_GC_PLANE_MASK: ::libc::c_uint = 2;
pub static XCB_GC_FOREGROUND: ::libc::c_uint = 4;
pub static XCB_GC_BACKGROUND: ::libc::c_uint = 8;
pub static XCB_GC_LINE_WIDTH: ::libc::c_uint = 16;
pub static XCB_GC_LINE_STYLE: ::libc::c_uint = 32;
pub static XCB_GC_CAP_STYLE: ::libc::c_uint = 64;
pub static XCB_GC_JOIN_STYLE: ::libc::c_uint = 128;
pub static XCB_GC_FILL_STYLE: ::libc::c_uint = 256;
pub static XCB_GC_FILL_RULE: ::libc::c_uint = 512;
pub static XCB_GC_TILE: ::libc::c_uint = 1024;
pub static XCB_GC_STIPPLE: ::libc::c_uint = 2048;
pub static XCB_GC_TILE_STIPPLE_ORIGIN_X: ::libc::c_uint = 4096;
pub static XCB_GC_TILE_STIPPLE_ORIGIN_Y: ::libc::c_uint = 8192;
pub static XCB_GC_FONT: ::libc::c_uint = 16384;
pub static XCB_GC_SUBWINDOW_MODE: ::libc::c_uint = 32768;
pub static XCB_GC_GRAPHICS_EXPOSURES: ::libc::c_uint = 65536;
pub static XCB_GC_CLIP_ORIGIN_X: ::libc::c_uint = 131072;
pub static XCB_GC_CLIP_ORIGIN_Y: ::libc::c_uint = 262144;
pub static XCB_GC_CLIP_MASK: ::libc::c_uint = 524288;
pub static XCB_GC_DASH_OFFSET: ::libc::c_uint = 1048576;
pub static XCB_GC_DASH_LIST: ::libc::c_uint = 2097152;
pub static XCB_GC_ARC_MODE: ::libc::c_uint = 4194304;
pub type xcb_gc_t = Enum_xcb_gc_t;
pub type Enum_xcb_gx_t = ::libc::c_uint;
pub static XCB_GX_CLEAR: ::libc::c_uint = 0;
pub static XCB_GX_AND: ::libc::c_uint = 1;
pub static XCB_GX_AND_REVERSE: ::libc::c_uint = 2;
pub static XCB_GX_COPY: ::libc::c_uint = 3;
pub static XCB_GX_AND_INVERTED: ::libc::c_uint = 4;
pub static XCB_GX_NOOP: ::libc::c_uint = 5;
pub static XCB_GX_XOR: ::libc::c_uint = 6;
pub static XCB_GX_OR: ::libc::c_uint = 7;
pub static XCB_GX_NOR: ::libc::c_uint = 8;
pub static XCB_GX_EQUIV: ::libc::c_uint = 9;
pub static XCB_GX_INVERT: ::libc::c_uint = 10;
pub static XCB_GX_OR_REVERSE: ::libc::c_uint = 11;
pub static XCB_GX_COPY_INVERTED: ::libc::c_uint = 12;
pub static XCB_GX_OR_INVERTED: ::libc::c_uint = 13;
pub static XCB_GX_NAND: ::libc::c_uint = 14;
pub static XCB_GX_SET: ::libc::c_uint = 15;
pub type xcb_gx_t = Enum_xcb_gx_t;
pub type Enum_xcb_line_style_t = ::libc::c_uint;
pub static XCB_LINE_STYLE_SOLID: ::libc::c_uint = 0;
pub static XCB_LINE_STYLE_ON_OFF_DASH: ::libc::c_uint = 1;
pub static XCB_LINE_STYLE_DOUBLE_DASH: ::libc::c_uint = 2;
pub type xcb_line_style_t = Enum_xcb_line_style_t;
pub type Enum_xcb_cap_style_t = ::libc::c_uint;
pub static XCB_CAP_STYLE_NOT_LAST: ::libc::c_uint = 0;
pub static XCB_CAP_STYLE_BUTT: ::libc::c_uint = 1;
pub static XCB_CAP_STYLE_ROUND: ::libc::c_uint = 2;
pub static XCB_CAP_STYLE_PROJECTING: ::libc::c_uint = 3;
pub type xcb_cap_style_t = Enum_xcb_cap_style_t;
pub type Enum_xcb_join_style_t = ::libc::c_uint;
pub static XCB_JOIN_STYLE_MITER: ::libc::c_uint = 0;
pub static XCB_JOIN_STYLE_ROUND: ::libc::c_uint = 1;
pub static XCB_JOIN_STYLE_BEVEL: ::libc::c_uint = 2;
pub type xcb_join_style_t = Enum_xcb_join_style_t;
pub type Enum_xcb_fill_style_t = ::libc::c_uint;
pub static XCB_FILL_STYLE_SOLID: ::libc::c_uint = 0;
pub static XCB_FILL_STYLE_TILED: ::libc::c_uint = 1;
pub static XCB_FILL_STYLE_STIPPLED: ::libc::c_uint = 2;
pub static XCB_FILL_STYLE_OPAQUE_STIPPLED: ::libc::c_uint = 3;
pub type xcb_fill_style_t = Enum_xcb_fill_style_t;
pub type Enum_xcb_fill_rule_t = ::libc::c_uint;
pub static XCB_FILL_RULE_EVEN_ODD: ::libc::c_uint = 0;
pub static XCB_FILL_RULE_WINDING: ::libc::c_uint = 1;
pub type xcb_fill_rule_t = Enum_xcb_fill_rule_t;
pub type Enum_xcb_subwindow_mode_t = ::libc::c_uint;
pub static XCB_SUBWINDOW_MODE_CLIP_BY_CHILDREN: ::libc::c_uint = 0;
pub static XCB_SUBWINDOW_MODE_INCLUDE_INFERIORS: ::libc::c_uint = 1;
pub type xcb_subwindow_mode_t = Enum_xcb_subwindow_mode_t;
pub type Enum_xcb_arc_mode_t = ::libc::c_uint;
pub static XCB_ARC_MODE_CHORD: ::libc::c_uint = 0;
pub static XCB_ARC_MODE_PIE_SLICE: ::libc::c_uint = 1;
...
pub static XCB_CLIP_ORDERING_UNSORTED: ::libc::c_uint = 0;
pub static XCB_CLIP_ORDERING_Y_SORTED: ::libc::c_uint = 1;
pub static XCB_CLIP_ORDERING_YX_SORTED: ::libc::c_uint = 2;
pub static XCB_CLIP_ORDERING_YX_BANDED: ::libc::c_uint = 3;
...
pub static XCB_COORD_MODE_ORIGIN: ::libc::c_uint = 0;
pub static XCB_COORD_MODE_PREVIOUS: ::libc::c_uint = 1;
...
pub static XCB_POLY_SHAPE_COMPLEX: ::libc::c_uint = 0;
pub static XCB_POLY_SHAPE_NONCONVEX: ::libc::c_uint = 1;
pub static XCB_POLY_SHAPE_CONVEX: ::libc::c_uint = 2;
...
pub static XCB_IMAGE_FORMAT_XY_BITMAP: ::libc::c_uint = 0;
pub static XCB_IMAGE_FORMAT_XY_PIXMAP: ::libc::c_uint = 1;
pub static XCB_IMAGE_FORMAT_Z_PIXMAP: ::libc::c_uint = 2;
...
pub static XCB_COLORMAP_ALLOC_NONE: ::libc::c_uint = 0;
pub static XCB_COLORMAP_ALLOC_ALL: ::libc::c_uint = 1;
...
pub static XCB_COLOR_FLAG_RED: ::libc::c_uint = 1;
pub static XCB_COLOR_FLAG_GREEN: ::libc::c_uint = 2;
pub static XCB_COLOR_FLAG_BLUE: ::libc::c_uint = 4;
...
pub static XCB_PIXMAP_NONE: ::libc::c_uint = 0;
...
pub static XCB_FONT_NONE: ::libc::c_uint = 0;
...
pub static XCB_QUERY_SHAPE_OF_LARGEST_CURSOR: ::libc::c_uint = 0;
pub static XCB_QUERY_SHAPE_OF_FASTEST_TILE: ::libc::c_uint = 1;
pub static XCB_QUERY_SHAPE_OF_FASTEST_STIPPLE: ::libc::c_uint = 2;
...
pub static XCB_KB_KEY_CLICK_PERCENT: ::libc::c_uint = 1;
pub static XCB_KB_BELL_PERCENT: ::libc::c_uint = 2;
pub static XCB_KB_BELL_PITCH: ::libc::c_uint = 4;
pub static XCB_KB_BELL_DURATION: ::libc::c_uint = 8;
pub static XCB_KB_LED: ::libc::c_uint = 16;
pub static XCB_KB_LED_MODE: ::libc::c_uint = 32;
pub static XCB_KB_KEY: ::libc::c_uint = 64;
pub static XCB_KB_AUTO_REPEAT_MODE: ::libc::c_uint = 128;
pub type xcb_kb_t = Enum_xcb_kb_t;
pub type Enum_xcb_led_mode_t = ::libc::c_uint;
pub static XCB_LED_MODE_OFF: ::libc::c_uint = 0;
pub static XCB_LED_MODE_ON: ::libc::c_uint = 1;
pub type xcb_led_mode_t = Enum_xcb_led_mode_t;
pub type Enum_xcb_auto_repeat_mode_t = ::libc::c_uint;
pub static XCB_AUTO_REPEAT_MODE_OFF: ::libc::c_uint = 0;
pub static XCB_AUTO_REPEAT_MODE_ON: ::libc::c_uint = 1;
pub static XCB_AUTO_REPEAT_MODE_DEFAULT: ::libc::c_uint = 2;
...
pub static XCB_BLANKING_NOT_PREFERRED: ::libc::c_uint = 0;
pub static XCB_BLANKING_PREFERRED: ::libc::c_uint = 1;
pub static XCB_BLANKING_DEFAULT: ::libc::c_uint = 2;
pub type xcb_blanking_t = Enum_xcb_blanking_t;
pub type Enum_xcb_exposures_t = ::libc::c_uint;
pub static XCB_EXPOSURES_NOT_ALLOWED: ::libc::c_uint = 0;
pub static XCB_EXPOSURES_ALLOWED: ::libc::c_uint = 1;
pub static XCB_EXPOSURES_DEFAULT: ::libc::c_uint = 2;
...
pub static XCB_HOST_MODE_INSERT: ::libc::c_uint = 0;
pub static XCB_HOST_MODE_DELETE: ::libc::c_uint = 1;
pub type xcb_host_mode_t = Enum_xcb_host_mode_t;
pub type Enum_xcb_family_t = ::libc::c_uint;
pub static XCB_FAMILY_INTERNET: ::libc::c_uint = 0;
pub static XCB_FAMILY_DECNET: ::libc::c_uint = 1;
pub static XCB_FAMILY_CHAOS: ::libc::c_uint = 2;
pub static XCB_FAMILY_SERVER_INTERPRETED: ::libc::c_uint = 5;
pub static XCB_FAMILY_INTERNET_6: ::libc::c_uint = 6;
...
pub static XCB_ACCESS_CONTROL_DISABLE: ::libc::c_uint = 0;
pub static XCB_ACCESS_CONTROL_ENABLE: ::libc::c_uint = 1;
...
pub static XCB_CLOSE_DOWN_DESTROY_ALL: ::libc::c_uint = 0;
pub static XCB_CLOSE_DOWN_RETAIN_PERMANENT: ::libc::c_uint = 1;
pub static XCB_CLOSE_DOWN_RETAIN_TEMPORARY: ::libc::c_uint = 2;
...
pub static XCB_KILL_ALL_TEMPORARY: ::libc::c_uint = 0;
...
pub static XCB_SCREEN_SAVER_RESET: ::libc::c_uint = 0;
pub static XCB_SCREEN_SAVER_ACTIVE: ::libc::c_uint = 1;
...
pub static XCB_MAPPING_STATUS_SUCCESS: ::libc::c_uint = 0;
pub static XCB_MAPPING_STATUS_BUSY: ::libc::c_uint = 1;
pub static XCB_MAPPING_STATUS_FAILURE: ::libc::c_uint = 2;
...
pub static XCB_MAP_INDEX_SHIFT: ::libc::c_uint = 0;
pub static XCB_MAP_INDEX_LOCK: ::libc::c_uint = 1;
pub static XCB_MAP_INDEX_CONTROL: ::libc::c_uint = 2;
pub static XCB_MAP_INDEX_1: ::libc::c_uint = 3;
pub static XCB_MAP_INDEX_2: ::libc::c_uint = 4;
pub static XCB_MAP_INDEX_3: ::libc::c_uint = 5;
pub static XCB_MAP_INDEX_4: ::libc::c_uint = 6;
pub static XCB_MAP_INDEX_5: ::libc::c_uint = 7;
